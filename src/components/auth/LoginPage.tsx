        ...
        <div className="bg-white/95 backdrop-blur-xl py-8 px-6 sm:px-10 shadow-2xl rounded-3xl border border-white/20 space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-xs font-bold text-slate-500">
              <span>الدخول التجريبي المباشر (Demo Fast Access)</span>
            ...
            <div className="grid grid-cols-1 gap-2.5">
              ...
              <button
                type="button"
                onClick={() => handleQuickLogin('tamer@ebda.edu.eg', 'teacher123')}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-extrabold text-xs text-slate-900">بوابة المعلم (م. تامر عبد الحميد)</div>
