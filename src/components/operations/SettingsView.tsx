    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12 text-right">
      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs space-y-1">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-extrabold text-slate-900 flex items-center gap-2">
            ...
            إعدادات التشغيل والملف الشخصي (Operations Settings)
          </h1>
        ...
        <p className="text-xs text-slate-500">
          تعديل بيانات مدير العمليات والتشغيل، تكوين المعايير التشغيلية لمدرسة {activeSchool.nameAr}، وقواعد التدقيق الأكاديمي
        </p>
      </div>
      ...
      <form onSubmit={handleSavePolicies} className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xs space-y-6">
        ...
        <div className="space-y-3 pb-6 border-b border-slate-100">
          ...
          <p className="text-xs text-slate-500">
            فحص لحظي يمنع تكرار تكليف المعلم، حجز نفس الفصل أو المعمل في نفس التوقيت
          </p>
        ...
        <div className="space-y-3 pb-6 border-b border-slate-100">
          ...
          <p className="text-xs text-slate-500">
            تحديد الصلاحيات الافتراضية لإتاحة روابط Google Drive والملازم لأولياء الأمور
          </p>
