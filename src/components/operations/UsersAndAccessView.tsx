  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <Modal
        ...
        subtitle={activeSelectedUser ? `كلمة المرور المؤقتة الجديدة للحساب ${activeSelectedUser.username}` : ''}
      >
        <div className="space-y-4 text-right">
          <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 space-y-2">
            <p className="text-xs font-bold text-amber-800">
              يرجى نسخ كلمة المرور وتزويد المستخدم بها لتسجيل الدخول:
            </p>
            <div className="flex items-center justify-between p-3 rounded-xl bg-white border border-amber-300 font-mono text-sm font-black text-slate-900 tracking-wider">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold transition shadow-2xs"
              >
                {copiedPassword ? (
                  <>
          ...
          <p className="text-[11px] text-slate-500 font-medium">
            سيطلب النظام من المستخدم تغيير كلمة المرور عند أول تسجيل دخول قادم لأسباب تتعلق بالأمان والسرية.
          </p>
